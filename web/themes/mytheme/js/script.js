(function ($) {
  $(document).ready(function() {
    ...
    var elements2 = document.querySelectorAll(".views-field-field-list-1 .form-select  > *:not(:nth-child(4))");
    var elements3 = document.querySelectorAll(".views-field-field-apr-teamlead-1 .form-submit");
    var elements4 = document.querySelectorAll(".views-field-field-list-1 .form-submit");
